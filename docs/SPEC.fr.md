...
- **Effort de raisonnement** : DeepSeek V4 Pro prend en charge l'effort de raisonnement High / Max en mode Thinking ; V4 Flash prend en charge Low / High / Max. L'effort de raisonnement est désactivé en mode Normal. Un effort hérité `low`/`medium` enregistré pour une route V4 Pro est migré vers `high` au démarrage.
