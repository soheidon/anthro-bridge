...
export const translations = {
  ...
  "modelPricing.notes.gpt56Promotion": "A limited-time 50% provider discount is applied on OpenRouter relative to OpenAI's revised standard price. No end date has been announced.",
