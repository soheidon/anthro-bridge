...
- **OpenRouter multi-profile**: Multiple OpenRouter profiles per user, each with its own API key and model configuration. Profile CRUD via Tauri commands. Active profile switching from dashboard or settings.
