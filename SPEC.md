...
- **GPT-5.6 model support**: OpenRouter profiles can use Sol, Terra, and Luna model variants, with capability-aware thinking controls and pricing notes for long-context rates where applicable.
