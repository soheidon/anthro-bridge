...
- **Nivel de razonamiento**: DeepSeek V4 Pro admite nivel de razonamiento High / Max en modo Thinking; V4 Flash admite Low / High / Max. El nivel de razonamiento está desactivado en modo Normal. Un nivel heredado `low`/`medium` almacenado para una ruta V4 Pro se migra a `high` al iniciar.
