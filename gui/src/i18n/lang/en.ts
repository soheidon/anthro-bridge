...
export const translations = {
  ...
  "statusPanel.providerHint": "Opus 4.8 / Sonnet 5 / Haiku 4.5 requests from Claude Desktop are routed to your chosen provider below.",
  ...
  "statusPanel.tileHint": "Claude Desktop shows Opus 4.8 / Sonnet 5 / Haiku 4.5. The tiles below choose which actual LLM provider handles those requests.",
  ...
  "claudeConfig.providerHint": "Claude Desktop always sees the same 3 model names (Opus 4.8 / Sonnet 5 / Haiku 4.5). The gateway routes them to your chosen provider below.",
