...
export const translations = {
  ...
  "header.settingsClose": "Close Settings",
  ...
  "language.desc": "Select the UI language.",
  ...
  "statusPanel.providerHint": "Opus 5 / Sonnet 5 / Haiku 4.5 requests from Claude Desktop are routed to your chosen provider below.",
  "statusPanel.restarting": "Switching provider, restarting gateway...",
  "statusPanel.restarted": "Provider changed. Gateway restarted.",
  "statusPanel.savedNextStart": "Saved. Takes effect on next gateway start.",
  ...
  "statusPanel.tileOllamaActive": "Claude Code Active",
  "statusPanel.tileOllamaSubtitle": "Claude Code Only",
  ...
  "statusPanel.tileHint": "Claude Desktop shows Opus 5 / Sonnet 5 / Haiku 4.5. The tiles below choose which actual LLM provider handles those requests.",
  "statusPanel.colInputPrice": "Input/1M",
  "statusPanel.colOutputPrice": "Output/1M",
  ...
  "configPanel.desc": "Server settings, backup/restore, import, and advanced configuration.",
  "configPanel.collapsedDesc": "Server settings, backup/restore, import, and advanced configuration.",
  ...
  "configPanel.serverConfig": "Server Config",
  ...
  "configPanel.backupDone": "Backup: {name}",
  "configPanel.restore": "Restore from .bak",
  "configPanel.restoreConfirm": "Restore config from .bak backup? Current config will be overwritten.",
  "configPanel.restoreDone": "Restored from backup",
  "configPanel.reset": "Reset to defaults",
  "configPanel.resetConfirm": "Reset config to factory defaults?\n\nThis will reset: active provider, model routing, thinking mode, API key env var names, and server settings.\nYour API keys (stored in environment variables) will NOT be deleted.\n\nA backup will be created before resetting. Continue?",
  "configPanel.resetDone": "Config reset to defaults",
  "configPanel.import": "Import Config",
  "configPanel.importLabel": "Paste config JSON to import:",
  "configPanel.importValidate": "Validate & Import",
  "configPanel.importDone": "Config imported",
  "configPanel.importInvalidJson": "Invalid JSON",
  "configPanel.advancedToggle": "Advanced: Edit config.json directly",
  "configPanel.advancedWarning": "Editing raw JSON can break the gateway. Use only if you understand the config format.",
  "configPanel.gatewayRestartNote": "Changes take effect on next gateway restart. Stop → Start to apply.",
  ...
  "apiKeyPanel.localLlmSectionTitle": "Local LLM",
  ...
  "apiKeyPanel.ollamaLocal.showOnDashboard": "Show on Dashboard",
  "apiKeyPanel.ollamaLocal.refresh": "Refresh",
  "apiKeyPanel.ollamaLocal.refreshing": "Refreshing...",
  "apiKeyPanel.ollamaLocal.advancedSettings": "Advanced Settings",
  "apiKeyPanel.ollamaLocal.fetchFailed": "Could not fetch models from Ollama (is Ollama running?)",
  "apiKeyPanel.ollamaLocal.customModel": "Custom Model Tag",
  "apiKeyPanel.ollamaLocal.customModelPlaceholder": "e.g. llama3.3:70b",
  "apiKeyPanel.ollamaLocal.noModelsFound": "No installed models found",
  "apiKeyPanel.ollamaLocal.modelTag": "Model",
  "apiKeyPanel.ollamaLocal.thinking": "Thinking",
  "apiKeyPanel.ollamaLocal.thinkingNormal": "Normal (Disabled)",
  "apiKeyPanel.ollamaLocal.thinkingEnabled": "Thinking (Enabled)",
  "apiKeyPanel.ollamaLocal.endpoint": "Endpoint",
  "apiKeyPanel.ollamaLocal.vision": "Vision (Base64)",
  "apiKeyPanel.ollamaLocal.visionOff": "Off",
  "apiKeyPanel.ollamaLocal.visionOn": "On",
  "apiKeyPanel.ollamaLocal.contextWindow": "Context Window",
  "apiKeyPanel.ollamaLocal.contextWindowPlaceholder": "e.g. 131072 (optional)",
  "apiKeyPanel.ollamaLocal.apiKeyNotice": "API key not required for local loopback Ollama",
  ...
  "apiKeyPanel.envVarSaved": "Name saved",
    "apiKeyPanel.savingStatus": "Saving...",
    "apiKeyPanel.savedStatus": "Saved",
    "apiKeyPanel.errorStatus": "Save failed",
  ...
  "apiKeyPanel.kimiCodeNote": "For Kimi Code subscription. Requires a separate API key from the standard Kimi API.",
  ...
  "apiKeyPanel.visionNotSupported": "This provider does NOT support image input. To use vision/image features, switch the active provider to MiniMax or Kimi.",
  ...
  "apiKeyPanel.customModel": "Custom...",
  "apiKeyPanel.customPlaceholder": "Enter model name",
  ...
  "apiKeyPanel.reasoningEffort": "Reasoning effort",
  ...
  "modelPricing.colProvider": "Provider",
  "modelPricing.colModel": "Model",
  "modelPricing.colInput": "Input/1M",
  "modelPricing.colOutput": "Output/1M",
  ...
  "modelPricing.pricingDate": "Prices as of Sep 10, 2026",
  ...
  "modelPricing.notes.deepseekV4ProTransition": "DeepSeek V4 Pro transition pricing during DeepSeek V4.1 rollout.",
  "modelPricing.notes.deepseekV4ProGoingAway": "Scheduled for retirement on September 14, 2026.",
  ...
  "modelPricing.notes.kimiCodeSubscription": "Kimi Code is a membership subscription product with monthly/annual quotas. No public per-token API pricing applies.",
  "modelPricing.notes.openrouterPricing": "OpenRouter pricing. Prices are based on OpenRouter model API.",
  "modelPricing.notes.gpt56StandardPrice": "OpenAI's revised standard price; no discount is applied.",
  "modelPricing.notes.gpt56Promotion": "Limited-time promotional pricing is currently active on OpenRouter for this model. No end date has been announced.",
  "modelPricing.notes.gpt56LongContext": "Prompts of 272K tokens or more use long-context pricing.",
  "modelPricing.discountedPriceAria": "Current price {current}, revised standard price {regular}",
  "peakValley.peak": "PEAK",
  "peakValley.valley": "VALLEY",
  "peakValley.pricingDisplayTimezone": "Display timezone",
  "peakValley.pricingDisplayTimezoneHint": "DeepSeek peak/valley hours are displayed in this timezone.",
  ...
  "openRouterModels.refreshing": "Refreshing model list...",
  ...
  "openRouterModels.selectModel": "Select a model",
  "openRouterModels.selectVendor": "Select vendor...",
  "openRouterModels.selectGroup": "Select group...",
  ...
  "openRouterModels.loading": "Loading models...",
  "openRouterModels.error": "Error:",
  "openRouterModels.empty": "No models available",
  "openRouterModels.cached": "Cached",
  "openRouterModels.ageMinutes": "just now",
  ...
  "openRouterProfile.dragHandle": "Drag to reorder",
  "dashboard.openrouterProfileSwitch": "Switching model set…",

  // Timezone groups
  "timezone.group.major": "Major",
  "timezone.group.eastAsia": "Japan & East Asia",
  "timezone.group.southEastAsia": "Southeast & South Asia",
  "timezone.group.middleEast": "Middle East",
  "timezone.group.europe": "Europe",
  "timezone.group.northAmerica": "North America",
  "timezone.group.latinAmerica": "Latin America",
  "timezone.group.oceania": "Oceania",
  "timezone.group.africa": "Africa",

  // Timezone labels
  "timezone.label.Asia/Tokyo": "JST (Japan / Tokyo)",
  "timezone.label.Asia/Shanghai": "CST (China / Shanghai)",
  "timezone.label.Asia/Seoul": "KST (Korea / Seoul)",
  "timezone.label.Asia/Singapore": "SGT (Singapore)",
  "timezone.label.Asia/Kolkata": "IST (India / Kolkata)",
  "timezone.label.Europe/London": "GMT / BST (UK / London)",
  "timezone.label.Europe/Paris": "CET / CEST (France / Paris)",
  "timezone.label.America/New_York": "ET (US Eastern / New York)",
  "timezone.label.America/Chicago": "CT (US Central / Chicago)",
  "timezone.label.America/Los_Angeles": "PT (US Pacific / Los Angeles)",
  "timezone.label.Australia/Sydney": "AEST / AEDT (Australia / Sydney)",
  "timezone.label.UTC": "UTC (Coordinated Universal Time)",
  "timezone.label.Asia/Hong_Kong": "HKT (Hong Kong)",
  "timezone.label.Asia/Taipei": "TST (Taiwan / Taipei)",
  "timezone.label.Asia/Bangkok": "ICT (Thailand / Bangkok)",
  "timezone.label.Asia/Jakarta": "WIB (Indonesia / Jakarta)",
  "timezone.label.Asia/Manila": "PHT (Philippines / Manila)",
  ...
  "timezone.label.Asia/Dhaka": "BST (Bangladesh / Dhaka)",
  "timezone.label.Asia/Dubai": "GST (UAE / Dubai)",
  "timezone.label.Asia/Riyadh": "AST (Saudi Arabia / Riyadh)",
  "timezone.label.Europe/Istanbul": "TRT (Turkey / Istanbul)",
  "timezone.label.Asia/Jerusalem": "IDT (Israel / Jerusalem)",
  "timezone.label.Europe/Lisbon": "WET / WEST (Portugal / Lisbon)",
  "timezone.label.Europe/Berlin": "CET / CEST (Germany / Berlin)",
  "timezone.label.Europe/Rome": "CET / CEST (Italy / Rome)",
  "timezone.label.Europe/Helsinki": "EET / EEST (Finland / Helsinki)",
  "timezone.label.Europe/Athens": "EET / EEST (Greece / Athens)",
  "timezone.label.Europe/Moscow": "MSK (Russia / Moscow)",
  "timezone.label.America/Denver": "MT (US Mountain / Denver)",
  "timezone.label.America/Phoenix": "MST (US / Arizona)",
  "timezone.label.America/Anchorage": "AKT (US / Alaska)",
  "timezone.label.Pacific/Honolulu": "HST (US / Hawaii)",
  "timezone.label.America/Halifax": "AT (Canada Atlantic / Halifax)",
  "timezone.label.America/St_Johns": "NST / NDT (Canada / Newfoundland)",
  "timezone.label.America/Toronto": "ET (Canada / Toronto)",
  "timezone.label.America/Vancouver": "PT (Canada / Vancouver)",
  "timezone.label.America/Mexico_City": "CST (Mexico / Mexico City)",
  "timezone.label.America/Sao_Paulo": "BRT (Brazil / São Paulo)",
  ...
  "timezone.label.Australia/Adelaide": "ACST / ACDT (Australia / Adelaide)",
  "timezone.label.Australia/Perth": "AWST (Australia / Perth)",
  "timezone.label.Pacific/Auckland": "NZST / NZDT (New Zealand / Auckland)",
  "timezone.label.Africa/Johannesburg": "SAST (South Africa / Johannesburg)",
  "timezone.label.Africa/Nairobi": "EAT (Kenya / Nairobi)",
  "timezone.label.Africa/Lagos": "WAT (Nigeria / Lagos)",
  "timezone.label.Africa/Cairo": "EET (Egypt / Cairo)",
} as const;
