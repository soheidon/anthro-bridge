export const translations = {
  en: {
    ...
    "claudeConfig.dashboardNote": "Config that lets Claude Desktop connect to this gateway. Copy the JSON below and paste it into your Claude Desktop config file. Switch the actual LLM provider on the main screen.",
    ...
    "apiKeyPanel.helpText": "Store API keys for each provider.",
  ...
  ja: {
    ...
    "claudeConfig.dashboardNote": "Claude Desktop がこのゲートウェイに接続できるようにする設定です。下のボタンで設定JSONをコピーし、Claude Desktop の設定ファイルに貼り付けてください。使用するLLMプロバイダはメイン画面で切り替えます。",
    ...
    "apiKeyPanel.helpText": "各プロバイダのAPIキーを保存します。",
